...
```bash
git remote add encore encore://getpaid-connect-pwa-tth2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/getpaid-connect-pwa-tth2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/getpaid-connect-pwa-tth2/settings/integrations/github)
